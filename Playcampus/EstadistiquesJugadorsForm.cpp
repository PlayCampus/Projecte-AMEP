...
namespace CppCLRWinFormsProject {
	...
	void EstadistiquesJugadorsForm::InitializeComponent() {
		...
		// ConfiguraciÃ³n general del formulario
		this->Text = L"EstadÃ­stiques dels Jugadors";
		...
		// lblTitle
		this->lblTitle->Text = L"EstadÃ­stiques dels Jugadors";
	...
	void EstadistiquesJugadorsForm::DesignForm() {
		// ConfiguraciÃ³n adicional de diseÃ±o si es necesaria
	}
	...
	void EstadistiquesJugadorsForm::CarregarEstadistiques() {
		try {
			...
			DataTable^ dt = ctrl->ObtenirTotesEstadistiquesJugadors();
